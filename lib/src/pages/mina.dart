...
import 'minas_detalle.dart';

class MinaPage extends StatefulWidget {

  static const String routeName = '/minas';

  _MinaPageState createState() => _MinaPageState();
}

class _MinaPageState extends State<MinaPage> with SingleTickerProviderStateMixin {
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => MinasDetalle(minas: mina[index]),
            ),
          );
        },
        child: Stack(
            ...
            Container(
              ...
              child: Stack(
                children: <Widget>[
                  Center(
                    child: Hero(
                      tag: mina[index].imageUrl,
                      child: Image(
                        height: 280.0,
                        width: 280.0,
                        image: AssetImage(
                          'images/mina$index.png',
                        ),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ...
                  Positioned(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text(
                          mina[index].category.toUpperCase(),
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 15.0,
                          ),
    ...
    var header = DrawerHeader(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage('images/imgf3.jpeg'),
            fit: BoxFit.cover
          )
        )
          ...
          children: <Widget>[
            ...
            TabBar(
              ...
              tabs: <Widget>[
                Tab(
                  child:    FlatButton(
                     child: Text("Rocas",  textAlign: TextAlign.end,
                     style: TextStyle(
                       fontSize: 16, 
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    mina[_selectedPage].description,
                    style: TextStyle(
